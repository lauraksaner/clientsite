...
function bt_acf_register_blocks() {
	...
	if ( function_exists( 'acf_register_block' ) ) {
		...
		acf_register_block_type(
			array(
				'name'            => 'horizscrolltext',
				'title'           => esc_attr__( 'Horizontal Scroll Text', 'basetheme' ),
				'description'     => esc_attr__( 'Text that scrolls horizontally as the user scrolls the page.', 'basetheme' ),
				'render_callback' => 'bt_acf_block_render_callback',
				'category'        => BT_ACF_BLOCKS_CATEGORY,
				'icon'            => $icon,
				'keywords'        => array( 'text', 'animation', BT_ACF_BLOCKS_KEYWORD ),
				'mode'            => BT_ACF_BLOCKS_MODE,
				'enqueue_style'   => get_template_directory_uri() . '/dist/css/blocks/horizscrolltext.css',
				'enqueue_script'  => get_template_directory_uri() . '/dist/js/blocks/block-horizscrolltext.min.js',
			)
		);
		...
		acf_register_block_type(
			array(
				'name'            => 'projectind',
				'title'           => esc_attr__( 'Project Industries', 'basetheme' ),
				'description'     => esc_attr__( 'Display a list of project industries with icons.', 'basetheme' ),
				'render_callback' => 'bt_acf_block_render_callback',
				'category'        => BT_ACF_BLOCKS_CATEGORY,
				'icon'            => $icon,
				'keywords'        => array( 'taxonomy', 'industries', 'industry', BT_ACF_BLOCKS_KEYWORD ),
				'mode'            => BT_ACF_BLOCKS_MODE,
			)
		);
		...
		acf_register_block_type(
			array(
				'name'            => 'projectgrid',
				'title'           => esc_attr__( 'Project Grid', 'basetheme' ),
				'description'     => esc_attr__( 'Grid display of projects with blue overlay.', 'basetheme' ),
				'render_callback' => 'bt_acf_block_render_callback',
				'category'        => BT_ACF_BLOCKS_CATEGORY,
				'icon'            => $icon,
				'keywords'        => array( 'projects', 'grid', 'query', BT_ACF_BLOCKS_KEYWORD ),
				'mode'            => BT_ACF_BLOCKS_MODE,
				'enqueue_style'   => get_template_directory_uri() . '/dist/css/blocks/projectgrid.css',
			)
		);
