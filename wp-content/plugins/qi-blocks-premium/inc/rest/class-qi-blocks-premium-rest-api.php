...
if ( ! class_exists( 'Qi_Blocks_Premium_Rest_API' ) ) {
	/**
	 * Rest API class with configuration
	 */
	class Qi_Blocks_Premium_Rest_API {
		private static $instance;
		private $namespace;

		public function __construct() {
			// Init variables
			$this->set_namespace( 'qi-blocks-premium/v1' );
		...
		function localize_script( $global ) {
			...
			return apply_filters( 'qi_blocks_premium_filter_localize_main_js_rest_api', $global, $this->get_namespace() );
		}

		function register_rest_api_route() {
			$routes = apply_filters( 'qi_blocks_premium_filter_rest_api_routes', array() );
	...
	Qi_Blocks_Premium_Rest_API::get_instance();
}
