...
class Kadence_Blocks_Pro_Query_Block extends Kadence_Blocks_Pro_Abstract_Query_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		$css->set_selector(
			...
			'.wp-block-kadence-query' . $unique_id . ' input[type=tel],' .
			...
			'.wp-block-kadence-query' . $unique_id . ' input[type=email],' .
			'.wp-block-kadence-query' . $unique_id . ' input[type=file],' .
			'.wp-block-kadence-query' . $unique_id . ' input[type=email],' .
		...
		$css->set_selector(
			...
			'.wp-block-kadence-query' . $unique_id . ' input[type=email]:focus,' .
			'.wp-block-kadence-query' . $unique_id . ' input[type=tel]:focus,' .
			'.wp-block-kadence-query' . $unique_id . ' input[type=date]:focus,' .
			'.wp-block-kadence-query' . $unique_id . ' input[type=number]:focus,' .
			'.wp-block-kadence-query' . $unique_id . ' input[type=time]:focus,' .
			'.wp-block-kadence-query' . $unique_id . ' input[type=file]:focus,' .
	...
	public function register_scripts() {
		...
		wp_register_script( 'kadence-blocks-query', KBP_URL . 'dist/query.js', array(), KADENCE_BLOCKS_VERSION, true );
	}
