...
class Kadence_Blocks_Pro_Pagination_Block extends Kadence_Blocks_Query_Children_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		if( 'kadence' !== strtolower( wp_get_theme() ) ){
			wp_register_style( 'kadence-blocks-pro-query-pagination', KBP_URL . 'dist/style-blocks-query-pagination.css', array(), KBP_VERSION );
			wp_enqueue_style( 'kadence-blocks-pro-query-pagination' );
		}
