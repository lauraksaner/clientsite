...
class Kadence_Blocks_Pro_Card_Block extends Kadence_Blocks_Query_Children_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		$css->render_gap( $meta_attributes, 'rowGap', 'row-gap' );
		$css->render_gap( $meta_attributes, 'columnGap', 'column-gap' );

		// Item Container.
		$css->set_selector( '.wp-block-kadence-query-card' . $unique_id . ' .kb-query-grid-wrap .kb-query-item.kb-query-block-post' );
		$css->render_measure_output( $meta_attributes, 'padding', 'padding', array( 'desktop_key' => 'padding', 'tablet_key' => 'tabletPadding', 'mobile_key' => 'mobilePadding' ) );
		$css->render_measure_output( $meta_attributes, 'margin', 'margin', array( 'desktop_key' => 'margin', 'tablet_key' => 'tabletMargin', 'mobile_key' => 'mobileMargin' ) );
